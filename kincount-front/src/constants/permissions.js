...
// 兼容旧的权限常量（如果有的话）
export const PERM_ALIAS = {
  // 仪表盘
  DASHBOARD: PERM.DASHBOARD_VIEW,
  
  // 商品管理
  PRODUCT_VIEW: PERM.PRODUCT_VIEW,
  PRODUCT_ADD: PERM.PRODUCT_ADD,
  PRODUCT_EDIT: PERM.PRODUCT_EDIT,
  PRODUCT_DELETE: PERM.PRODUCT_DELETE,
  
  // 分类管理
  CATEGORY_VIEW: PERM.CATEGORY_VIEW,
  CATEGORY_ADD: PERM.CATEGORY_ADD,
  CATEGORY_EDIT: PERM.CATEGORY_EDIT,
  CATEGORY_DELETE: PERM.CATEGORY_DELETE,
  
  // 品牌管理
  BRAND_VIEW: PERM.BRAND_VIEW,
  BRAND_ADD: PERM.BRAND_ADD,
  BRAND_EDIT: PERM.BRAND_EDIT,
  BRAND_DELETE: PERM.BRAND_DELETE,
  
  // 客户管理
  CUSTOMER_VIEW: PERM.CUSTOMER_VIEW,
  CUSTOMER_ADD: PERM.CUSTOMER_ADD,
  CUSTOMER_EDIT: PERM.CUSTOMER_EDIT,
  CUSTOMER_DELETE: PERM.CUSTOMER_DELETE,
  
  // 供应商管理
  SUPPLIER_VIEW: PERM.SUPPLIER_VIEW,
  SUPPLIER_ADD: PERM.SUPPLIER_ADD,
  SUPPLIER_EDIT: PERM.SUPPLIER_EDIT,
  SUPPLIER_DELETE: PERM.SUPPLIER_DELETE,
  
  // 仓库管理
  WAREHOUSE_VIEW: PERM.WAREHOUSE_VIEW,
  WAREHOUSE_ADD: PERM.WAREHOUSE_ADD,
  WAREHOUSE_EDIT: PERM.WAREHOUSE_EDIT,
  WAREHOUSE_DELETE: PERM.WAREHOUSE_DELETE,
  
  // 采购管理（简化）
  PURCHASE_VIEW: PERM.PURCHASE_ORDER_VIEW,
  PURCHASE_ADD: PERM.PURCHASE_ORDER_ADD,
  PURCHASE_AUDIT: PERM.PURCHASE_ORDER_AUDIT,
  PURCHASE_DELETE: PERM.PURCHASE_ORDER_DELETE,
  
  // 销售管理（简化）
  SALE_VIEW: PERM.SALE_ORDER_VIEW,
  SALE_ADD: PERM.SALE_ORDER_ADD,
  SALE_EDIT: PERM.SALE_ORDER_EDIT,
  SALE_AUDIT: PERM.SALE_ORDER_AUDIT,
  SALE_DELETE: PERM.SALE_ORDER_DELETE,
  
  // 退货管理（简化）
  RETURN_STOCK_VIEW: PERM.RETURN_STOCK_VIEW,
  RETURN_STOCK_CREATE: PERM.RETURN_STOCK_CREATE,
  RETURN_STOCK_AUDIT: PERM.RETURN_STOCK_AUDIT,
  RETURN_STOCK_CANCEL: PERM.RETURN_STOCK_CANCEL,
  RETURN_VIEW: PERM.RETURN_ORDER_VIEW,
  
  // 库存管理（简化）
  STOCK_VIEW: PERM.STOCK_VIEW,
  STOCK_TAKE: PERM.STOCK_TAKE_VIEW,
  STOCK_TRANSFER: PERM.STOCK_TRANSFER_VIEW,
  STOCK_WARNING: PERM.STOCK_WARNING_VIEW,
  
  // 财务管理（简化）
  FINANCE_VIEW: PERM.FINANCIAL_RECORD_VIEW,
  FINANCE_ADD: PERM.FINANCIAL_RECORD_ADD,
  FINANCE_REPORT: PERM.FINANCIAL_REPORT_VIEW,
  
  // 系统管理（简化）
  USER_MANAGE: PERM.USER_VIEW, // 注意：这是简化版，实际可能需要多个权限
  ROLE_MANAGE: PERM.ROLE_VIEW, // 注意：这是简化版，实际可能需要多个权限
  CONFIG_MANAGE: PERM.CONFIG_VIEW // 注意：这是简化版，实际可能需要多个权限
}

// 导出一个合并的PERM对象，包含所有权限
